                ...
                function (data, status) {
                    if (data.length === 1) {
                        ...
                        if (data[0].telephone_num === null){
                            ...
                            newTextBoxDiv.after().html('<label>Enter Phone #:</label><input type="text" class="text_input_1" name="textbox1" id="textbox1" value="" ><label class="grey-label" id="char-counter"></label>')
...
$(document).on( 'keyup', '.text_input_1', function () {
    ...
    if (content.match(/\d{3}(.)?\d{3}(.)?\d{4}/)){
        ...
        new_input_box_string = '<label>Enter problem in 100 characters or less:</label><input type="text" name="textbox2" id="textbox2" value="" size="100">'
